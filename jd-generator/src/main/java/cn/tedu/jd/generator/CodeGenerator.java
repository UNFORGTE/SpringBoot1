...
public class CodeGenerator {
    ...
    public static String url = "jdbc:mysql://localhost:3306/dog?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    public static String username="root";
    public static String password="root";
    //父级别包名称
    public static String parentPackage = "cn.tedu.jd";
    //代码生成的目标路径
    public static String generateTo = "/jd-generator/src/main/java";
    //mapper.xml的生成路径
    public static String mapperXmlPath = "/jd-generator/src/main/resources/mapper";
    ...
    //模块名称，用于组成包名
    public static String modelName = "show";
